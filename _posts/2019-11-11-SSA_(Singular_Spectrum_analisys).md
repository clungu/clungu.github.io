...
<h1>Singular Spectrum Analisys<span class="tocSkip"></span></h1>
<div class="toc"><ul class="toc-item"><li><span><a href="#Problem-description" data-toc-modified-id="Problem-description-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Problem description</a></span><ul class="toc-item"><li><span><a href="#Generate-data" data-toc-modified-id="Generate-data-1.1"><span class="toc-item-num">1.1&nbsp;&nbsp;</span>Generate data</a></span></li><li><span><a href="#Definining-the-main-components-of-the-data" data-toc-modified-id="Definining-the-main-components-of-the-data-1.2"><span class="toc-item-num">1.2&nbsp;&nbsp;</span>Definining the main components of the data</a></span></li></ul></li><li><span><a href="#Idea-of-the-approach" data-toc-modified-id="Idea-of-the-approach-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>Idea of the approach</a></span></li><li><span><a href="#Choosing-an-approach" data-toc-modified-id="Choosing-an-approach-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>Choosing an approach</a></span></li><li><span><a href="#SSA-(Singular-Spectrum-analisys)-EDA" data-toc-modified-id="SSA-(Singular-Spectrum-analisys)-EDA-4"><span class="toc-item-num">4&nbsp;&nbsp;</span>SSA (Singular Spectrum analisys) EDA</a></span><ul class="toc-item"><li><span><a href="#Main-algorithm-description-of-SSA" data-toc-modified-id="Main-algorithm-description-of-SSA-4.1"><span class="toc-item-num">4.1&nbsp;&nbsp;</span><a href="https://en.wikipedia.org/wiki/Singular_spectrum_analysis" target="_blank">Main algorithm description of SSA</a></a></span><ul class="toc-item"><li><span><a href="#Step-1:-Embedding" data-toc-modified-id="Step-1:-Embedding-4.1.1"><span class="toc-item-num">4.1.1&nbsp;&nbsp;</span>Step 1: Embedding</a></span></li><li><span><a href="#Step-2:-Singular-Value-Decomposition-(SVD)" data-toc-modified-id="Step-2:-Singular-Value-Decomposition-(SVD)-4.1.2"><span class="toc-item-num">4.1.2&nbsp;&nbsp;</span>Step 2: Singular Value Decomposition (SVD)</a></span></li><li><span><a href="#Step-3:-Eigentriple-grouping" data-toc-modified-id="Step-3:-Eigentriple-grouping-4.1.3"><span class="toc-item-num">4.1.3&nbsp;&nbsp;</span>Step 3: Eigentriple grouping</a></span></li><li><span><a href="#Step-4:-Diagonal-averaging" data-toc-modified-id="Step-4:-Diagonal-averaging-4.1.4"><span class="toc-item-num">4.1.4&nbsp;&nbsp;</span>Step 4: Diagonal averaging</a></span></li></ul></li><li><span><a href="#Actual-implementation" data-toc-modified-id="Actual-implementation-4.2"><span class="toc-item-num">4.2&nbsp;&nbsp;</span>Actual implementation</a></span><ul class="toc-item"><li><span><a href="#Step-1:-Embedding" data-toc-modified-id="Step-1:-Embedding-4.2.1"><span class="toc-item-num">4.2.1&nbsp;&nbsp;</span>Step 1: Embedding</a></span></li><li><span><a href="#Step-2:-Applying-SVD" data-toc-modified-id="Step-2:-Applying-SVD-4.2.2"><span class="toc-item-num">4.2.2&nbsp;&nbsp;</span>Step 2: Applying SVD</a></span><ul class="toc-item"><li><span><a href="#The-wikipedia-way" data-toc-modified-id="The-wikipedia-way-4.2.2.1"><span class="toc-item-num">4.2.2.1&nbsp;&nbsp;</span>The wikipedia way</a></span></li><li><span><a href="#The-kaggle-way" data-toc-modified-id="The-kaggle-way-4.2.2.2"><span class="toc-item-num">4.2.2.2&nbsp;&nbsp;</span>The kaggle way</a></span></li><li><span><a href="#Comparing-the-two-elementary-matrices-sets" data-toc-modified-id="Comparing-the-two-elementary-matrices-sets-4.2.2.3"><span class="toc-item-num">4.2.2.3&nbsp;&nbsp;</span>Comparing the two elementary matrices sets</a></span></li><li><span><a href="#Understanting-each-elementary-matrices-contribution" data-toc-modified-id="Understanting-each-elementary-matrices-contribution-4.2.2.4"><span class="toc-item-num">4.2.2.4&nbsp;&nbsp;</span>Understanting each elementary matrices contribution</a></span></li><li><span><a href="#Partially-reconstructing-X,-by-only-using-the-top-4-components" data-toc-modified-id="Partially-reconstructing-X,-by-only-using-the-top-4-components-4.2.2.5"><span class="toc-item-num">4.2.2.5&nbsp;&nbsp;</span>Partially reconstructing X, by only using the top 4 components</a></span></li></ul></li><li><span><a href="#Step4:-Diagonal-averaging" data-toc-modified-id="Step4:-Diagonal-averaging-4.2.3"><span class="toc-item-num">4.2.3&nbsp;&nbsp;</span>Step4: Diagonal averaging</a></span><ul class="toc-item"><li><span><a href="#Henkelisation-of-the-elementary-matrices" data-toc-modified-id="Henkelisation-of-the-elementary-matrices-4.2.3.1"><span class="toc-item-num">4.2.3.1&nbsp;&nbsp;</span>Henkelisation of the elementary matrices</a></span></li><li><span><a href="#Extracting-the-elementary-timeseries" data-toc-modified-id="Extracting-the-elementary-timeseries-4.2.3.2"><span class="toc-item-num">4.2.3.2&nbsp;&nbsp;</span>Extracting the elementary timeseries</a></span></li></ul></li><li><span><a href="#Step-3:-Grouping" data-toc-modified-id="Step-3:-Grouping-4.2.4"><span class="toc-item-num">4.2.4&nbsp;&nbsp;</span>Step 3: Grouping</a></span><ul class="toc-item"><li><span><a href="#Computing-a-similarity-matrix" data-toc-modified-id="Computing-a-similarity-matrix-4.2.4.1"><span class="toc-item-num">4.2.4.1&nbsp;&nbsp;</span>Computing a similarity matrix</a></span></li><li><span><a href="#Clustering-the-components-using-the-similarity-matrix" data-toc-modified-id="Clustering-the-components-using-the-similarity-matrix-4.2.4.2"><span class="toc-item-num">4.2.4.2&nbsp;&nbsp;</span>Clustering the components using the similarity matrix</a></span></li></ul></li></ul></li><li><span><a href="#Results" data-toc-modified-id="Results-4.3"><span class="toc-item-num">4.3&nbsp;&nbsp;</span>Results</a></span></li></ul></li><li><span><a href="#Conclusions" data-toc-modified-id="Conclusions-5"><span class="toc-item-num">5&nbsp;&nbsp;</span>Conclusions</a></span></li></ul></div>
